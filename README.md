...
├── docs/
│   ├── 系统说明书.md               # 完整使用说明书
│   ├── 数据流设计图.md             # 数据管线全图（8 阶段架构）
│   ├── 数据加工管线与阅读规范.md   # 7 阶段数据管线 + 每日阅读优先级 + 指标口径
│   ├── 数据清洗阶段.md             # 清洗阶段说明
│   ├── VERSION.md                  # 版本与参数冻结
│   ├── CHANGELOG.md                # 版本演进
...
| [docs/数据流设计图.md](docs/数据流设计图.md) | 数据管线全图（8 阶段系统架构视图） |
| [docs/数据加工管线与阅读规范.md](docs/数据加工管线与阅读规范.md) | 7 阶段数据加工管线（数据处理视图）+ 每日阅读优先级 + 已确认指标口径 |
