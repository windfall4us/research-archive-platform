...
**Overall: `GO`** | 全网格 152 行（8 日期 × 19 L2），有信号 131 行

## 8 Gate
| Gate | 判定 | 关键值 |
|---|---|---|
| G1 DIRECT 重复计权 | ✅ | 186 raw → 134 analyst-theme-day 单位，mismatch=0 |
...
| G7 lineage 100% | ✅ | 断裂 0 |
| G8 重跑 dedupe | ✅ | 152 行，dup=0 |

## 事实源
- eligible events: 934（937−3 excluded）
- DIRECT mentions: 186 raw → 134 analyst-theme-day
