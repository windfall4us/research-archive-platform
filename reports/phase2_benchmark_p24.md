...
| Gate | 判定 | 关键值 |
| --- | --- | --- |
| G1 Market View eligible 口径 | ✅ | market 行=69, UNKNOWN=9, eligible=60; P2.0D 固化 aggregation_eligible_market_views=60 |
| G2 Theme Mention lineage | ✅ | mentions=186, orphan_record=0, orphan_snapshot=0 |
...
| G8 LOW_SIGNAL/Missing 语义 | ✅ | 08-16 19 行全 LOW_SIGNAL（非状态=无，高置信=无）; heat=0 行 34 全可解释（34） |
...
## Phase 2 分层总结
- **Data/Parser Readiness**: {"p20b": {"overall": "GO (P2.0B)"}, "p20c": {"overall": "GO (P2.0C)"}, "p20d": {"overall": "GO (P2.0D)"}, "key": {"mv_total": 69, "mv_eligible": 60, "tm_total": 186, "stock_events": 937, "exclusions": 3}}
- **Market Direction**: {"overall": "GO (P2.1)", "notes": "按日聚合 + 三轴独立 + Coverage Gate；风格分组解释层"}
- **Theme Heat**: {"overall": "GO (P2.2C/P2.2D)", "grid": "152 行（8 日期 × 19 L2）", "zero_explainable": "34/34"}
- **Theme Momentum**: {"overall": "GO (P2.3)", "rows": 152, "eff_dist": {"FADING": 13, "DISCOVERY": 23, "COOLING": 20, "HEATING": 3, "EMERGING": 5, "STABLE": 1}}
